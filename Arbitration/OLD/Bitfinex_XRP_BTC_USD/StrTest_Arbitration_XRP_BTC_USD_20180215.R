...
write.csv(resH, "ResH.csv", row.names = FALSE)
...
colnames(resl) <- x
for(lb in seq(-6.4,4.0,by=0.2)){
  for(ln in seq(lb+1,max(3.0,lb+1),by=0.2)){
...
setwd("C:/Users/AlgoTrader/Downloads")
write.csv(resL, "ResL.csv", row.names = FALSE)
