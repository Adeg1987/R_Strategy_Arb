...
colnames(resH) <- x
for(hb in seq(-0.4,0.4,by=0.1)){#for(hb in seq(-8.0,8.0,by=0.2)){
  for(hn in seq(hb-3,hb-0.4,by=0.1)){#for(hn in seq(min(-3.0,hb-3),hb-1,by=0.2)){
...
colnames(resL) <- x
for(lb in seq(-0.6,0.6,by=0.1)){#for(lb in seq(-8.0,8.0,by=0.2)){
  for(ln in seq(lb+0.4,lb+3,by=0.1)){#for(ln in seq(lb+1,max(3.0,lb+3),by=0.2)){
